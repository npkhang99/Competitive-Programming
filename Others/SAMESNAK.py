...
def ver_ver(s1,s2):
    if s1[0][0] != s2[0][0]:
        return False
    if s1[0][1] not in range(s2[0][1], s2[1][1]+1) and s1[1][1] not in range(s2[0][1], s2[1][1]+1):
        return False
    return True
...
def hor_hor(s1,s2):
    if s1[0][1] != s2[0][1]:
        return False
    if s1[0][0] not in range(s2[0][0], s2[1][0]+1) and s1[1][0] not in range(s2[0][0], s2[1][0]+1):
        return False
    return True
...
for _ in range(TC):
    ...
    if ver(snake1) and ver(snake2):
        if ver_ver(snake1,snake2): print('yes')
        else: print('no')
    
    if hor(snake1) and hor(snake2):
        if hor_hor(snake1,snake2): print('yes')
        else: print('no')
    
    if ver(snake1) and hor(snake2):
        if ver_hor(snake1,snake2): print('yes')
        else: print('no')
    
    if hor(snake1) and ver(snake2):
        if ver_hor(snake2,snake1): print('yes')
        else: print('no')
